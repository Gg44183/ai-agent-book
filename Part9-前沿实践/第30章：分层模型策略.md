...
任务分布（典型生产环境）:
┌──────────────────────────────────────────────────────────┐
│  Simple (50-60%)  │  Medium (30-40%)  │  Large (5-10%)   │
│  ██████████████████│███████████████████│████████          │
│  $0.0005/1K       │  $0.003/1K        │  $0.08/1K        │
└──────────────────────────────────────────────────────────┘
```
...
> ⚠️ **时效性提示** (2025-01): 模型定价和能力列表频繁变化。以下为示意配置，请查阅各厂商官网获取最新价格：[OpenAI Pricing](https://openai.com/pricing) | [Anthropic Pricing](https://www.anthropic.com/pricing) | [Google AI Pricing](https://ai.google.dev/pricing)
